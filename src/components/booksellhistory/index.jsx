...
export default class BookSellHistory extends React.Component {
    constructor(props) {
        super(props);
        const columns = [
            ...
            { title: 'State', dataIndex: 'ordered', key: 'ordered', 
              render: (text, record) => {
                  return record.ordered ?
                         <Tag color = "orange">ordered</Tag> :
            ...
            },
            {
                ...
                render: (text, record) => {
                    return (
                      <span>
                        <Button disabled = { record.ordered } type="primary" onClick={ () => this.handleClearOne(record) }>Clear It</Button>
                      </span>  
                    );
                }
              }
